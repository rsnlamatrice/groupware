...
class ReportingController extends ApplicationController {
	...
	function total_task_times($report_data = null, $task = null, $csv = null){
		...
		/*echo "ICICICIICICICICI CICICICI CI  CIICICICICICIC ICICIC";
		var_dump($context, null, $user, $st, $et, array_var($report_data, 'task_id', 0), $group_by, null, null, null, $timeslotType, $extra_conditions);
		echo "LALALALALLLAL AALAL  LA LA LA LA LALALALALLALALAL";*/
