...
function autocomplete_member_combo($name, $dimension_id, $options, $emptyText, $attributes, $forceSelection = true, $cmp_id = '', $listeners = array()) {
	...
	$current_module = array_var($attributes, 'current_module');
	...
	if ($is_ajax) {
		...
		$store_str = 'store: new Ext.data.Store({
			proxy: new Ext.data.HttpProxy({
				method:"GET",
				url: "'.get_url('dimension', 'initial_list_dimension_members_tree'
						, array('ajax' => 'true', 'dimension_id' => $dimension_id, 'onlyname' => '1'
							, 'current_module' => $current_module /* ED141208 */
						)).'"
			}),
