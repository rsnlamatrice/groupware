			...
			<div class="context-body" style="float: left;">
				<?php
					...
					if(!empty($dimensions_to_show)){
						/* ED141209 add current_module */
						render_member_selectors(Timeslots::instance()->getObjectTypeId(), $genid, null
									, array('select_current_context' => true
										, 'listeners' => $listeners
										, 'current_module' => 'timeslot')
									, $dimensions_to_skip, null, false);	
					}
					?>
