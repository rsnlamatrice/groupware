...
>
	...
	<div class="coInputMainBlock">
		...
		<div id="<?php echo $genid ?>add_custom_properties_div"><?php 
			...
			/* ED141218 : ajout du paramètre save_propertiesED141218 sinon, pas d'enregistrement.
			 * Voir application/controllers/MemberController.class.php ligne 520
			 */
			?><input type="hidden" name="save_propertiesED141218" value="1" />
		</div>
	...
	<?php echo submit_button($member == null || $member->isNew() ? lang('add member') : lang('save changes'),'s',array('style'=>'margin-top:0px;margin-left:10px', 'tabindex' => '5'
								     /* modification de l'input name="duplicate-member" */
								     , 'onclick' => 'var $this = $(this);'
									. ' var $input = $this.parents("form:first").find(\'input[name="duplicate-member"]\');'
									. ' $input.val("");'
								     )) ?>
	<?php /*ED150217*/
	if($member != null && !$member->isNew()){
		?><input type="hidden" name="duplicate-member" value=""/><?php
		echo submit_button('Dupliquer ce contexte','u',array(
