  	  ...
  	  // Do we need to insert data or we need to save it...
  		if($this->isNew()) {
  		  ...
  		  if(!DB::execute($this->getInsertQuery())) return false;
                    ...
                    // ED150217 : adds || $this->getColumnValue($autoincrement_column) == 0
                    if((!$autoincrement_column_modified || $this->getColumnValue($autoincrement_column) == 0)
                       && $this->columnExists($autoincrement_column)) {
